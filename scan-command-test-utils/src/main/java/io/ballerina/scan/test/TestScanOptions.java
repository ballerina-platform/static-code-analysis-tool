...
public class TestScanOptions {
    ...
    private TestScanOptions(Project project, PrintStream outputStream, boolean helpFlag, boolean platformTriggered,
    ...
    /**
     * Create a new {@code TestScanOptionsBuilder} instance.
     *
     * @param project the project to be scanned
     * @return a new {@code TestScanOptionsBuilder} instance
     */
    public static TestScanOptionsBuilder builder(Project project) {
        return new TestScanOptionsBuilder(project);
    }
    ...
    public static class TestScanOptionsBuilder {
        private final Project project;
        ...
        private TestScanOptionsBuilder(Project project) {
            this.project = project;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setOutputStream(PrintStream outputStream) {
            this.outputStream = outputStream;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setHelpFlag(boolean helpFlag) {
            this.helpFlag = helpFlag;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setPlatformTriggered(boolean platformTriggered) {
            this.platformTriggered = platformTriggered;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setTargetDir(String targetDir) {
            this.targetDir = targetDir;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setScanReport(boolean scanReport) {
            this.scanReport = scanReport;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setListRules(boolean listRules) {
            this.listRules = listRules;
            return this;
        }
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setIncludeRules(List<Rule> includeRules) {
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setExcludeRules(List<Rule> excludeRules) {
         ...
         * @return this builder
         */
        public TestScanOptionsBuilder setPlatforms(List<String> platforms) {
            this.platforms = Collections.unmodifiableList(platforms);
            return this;
        }

        /**
         * Build the {@code TestScanOptions} instance.
         *
         * @return the built {@code TestScanOptions} instance
         */
        public TestScanOptions build() {
            return new TestScanOptions(project, outputStream, helpFlag, platformTriggered,
