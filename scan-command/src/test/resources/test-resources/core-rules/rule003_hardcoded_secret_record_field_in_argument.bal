...
public function main() {
    printConfig(nested = {credential: {username: "sabthar", password: "secret"}});
    PasswordStrengthChecker checker = new;
    checker.checkStregth({username: "sabthar", password: "secret"});
    Client 'client = new (config = {nested: {credential: {username: "sabthar", password: "pwd"}}});
}
