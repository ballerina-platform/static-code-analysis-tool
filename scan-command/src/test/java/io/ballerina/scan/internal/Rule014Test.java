 ...
 * @since 0.1.0
 */
public class Rule014Test extends StaticCodeAnalyzerTest {
    @Test
    void testNonConfigVariableAssignmentToSecret() {
        String documentName = "rule014_non_config_variable_assignment_to_secret.bal";
    ...
    void testNonConfigVariableAssignmentToDefaultRecordField() {
        String documentName = "rule014_non_config_variable_assignment_to_default_record_field.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
    ...
    void testNonConfigVariableAssignmentToRecordFieldArgument() {
        String documentName = "rule014_non_config_variable_assignment_to_record_field_argument.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
    ...
    void testNonConfigSecretAsFunctionArgument() {
        String documentName = "rule014_non_config_secret_as_function_argument.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
    ...
    void testNonConfigSecretInMapField() {
        String documentName = "rule014_non_config_secret_in_map_field.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
        Assert.assertEquals(issues.size(), 3);
        List<Location> expectedIssueLocations = new ArrayList<>(List.of(
    ...
    void testNonConfigVariableAssignmentToDefaultParameter() {
        String documentName = "rule014_non_config_variable_assignment_to_default_parameter.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
        Assert.assertEquals(issues.size(), 2);
        List<Location> expectedIssueLocations = new ArrayList<>(List.of(
    ...
    void testNonConfigExpressionAssignmentToVariable() {
        String documentName = "rule014_non_config_expression.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
    ...
    void testNonConfigVariableAssignmentToObjectField() {
        String documentName = "rule014_non_config_variable_assignment_to_object_field.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
        Assert.assertEquals(issues.size(), 2);
        List<Location> expectedIssueLocations = new ArrayList<>(List.of(
    ...
    void testNonConfigValueInShortHandFieldNotation() {
        String documentName = "rule014_non_config_value_in_short_hand_field.bal";
        List<Issue> issues = analyze(documentName, List.of(NON_CONFIGURABLE_SECRET.rule()));
        Assert.assertEquals(issues.size(), 2);
