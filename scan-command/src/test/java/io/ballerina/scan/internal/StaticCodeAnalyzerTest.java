...
public class StaticCodeAnalyzerTest extends BaseTest {
    ...
    void testSelfComparisonAnalyzer() {
        ...
        assertIssue(issues.get(2), documentName, 11, 10, 11, 16, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(3), documentName, 12, 10, 12, 16, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(4), documentName, 13, 10, 13, 15, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(5), documentName, 14, 10, 14, 15, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(6), documentName, 15, 10, 15, 17, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(7), documentName, 16, 10, 16, 17, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(8), documentName, 17, 10, 17, 15, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(9), documentName, 18, 10, 18, 15, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(10), documentName, 19, 10, 19, 16, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(11), documentName, 20, 10, 20, 16, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        ...
        assertIssue(issues.get(14), documentName, 33, 10, 33, 20, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(15), documentName, 34, 10, 34, 20, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(16), documentName, 35, 10, 35, 19, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(17), documentName, 36, 10, 36, 19, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(18), documentName, 37, 10, 37, 21, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(19), documentName, 38, 10, 38, 21, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(20), documentName, 39, 10, 39, 19, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(21), documentName, 40, 10, 40, 19, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(22), documentName, 41, 10, 41, 20, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(23), documentName, 42, 10, 42, 20, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        ...
        assertIssue(issues.get(26), documentName, 55, 10, 55, 52, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(27), documentName, 56, 10, 56, 52, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(28), documentName, 57, 10, 57, 51, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(29), documentName, 58, 10, 58, 51, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(30), documentName, 59, 10, 59, 53, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_TRUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(31), documentName, 60, 10, 60, 53, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_FALSE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(32), documentName, 61, 10, 61, 51, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
        assertIssue(issues.get(33), documentName, 62, 10, 62, 51, "ballerina:6", 6,
                Constants.RuleDescription.OPERATION_ALWAYS_EVALUATE_TO_SELF_VALUE, RuleKind.CODE_SMELL);
