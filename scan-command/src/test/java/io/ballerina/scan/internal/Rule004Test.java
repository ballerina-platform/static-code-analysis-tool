...
public class Rule004Test extends StaticCodeAnalyzerTest {
    ...
    void testNonIsolatedPublicClassOrObjectConstructsUsage() {
        ...
        assertIssue(issues.get(1), documentName, 37, 0, 40, 2, "ballerina:4", 4,
                PUBLIC_NON_ISOLATED_CLASS_OR_OBJECT_CONSTRUCT, RuleKind.CODE_SMELL);
        assertIssue(issues.get(2), documentName, 57, 0, 60, 2, "ballerina:4", 4,
                PUBLIC_NON_ISOLATED_CLASS_OR_OBJECT_CONSTRUCT, RuleKind.CODE_SMELL);
        assertIssue(issues.get(3), documentName, 74, 0, 76, 1, "ballerina:4", 4,
                PUBLIC_NON_ISOLATED_CLASS_OR_OBJECT_CONSTRUCT, RuleKind.CODE_SMELL);
    }
}
